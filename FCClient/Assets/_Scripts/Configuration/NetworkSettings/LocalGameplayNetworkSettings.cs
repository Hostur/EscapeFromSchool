...
{
	public class LocalGameplayNetworkSettings : IFCNetworkSettings
	{
		public int FrameRate { get; set; } = 30;
		public int ClientsCapacity { get; } = 100;
		public int ServerAliveEntitiesCapacity { get; } = 100;
		...
		public string ServerName { get; } = "Local gameplay";
